...
prose and reported as a warning (`lib/lint.mjs:105`), never followed.
...
**The discarded alternative** is what most wikis do, and the comment in `lib/lib.mjs:371` gives the
...
as far as the file, and the fragment is dropped (`lib/lib.mjs:384`).
